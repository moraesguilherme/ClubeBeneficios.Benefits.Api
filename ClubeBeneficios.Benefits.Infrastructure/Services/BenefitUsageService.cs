...
public class BenefitUsageService : IBenefitUsageService
{
    ...
    public BenefitUsageService(
        IBenefitUsageRepository repository,
    ...
    public Task<Guid> ConfirmAdminAsync(
        ConfirmBenefitUsageRequest request,
        CancellationToken cancellationToken = default)
    {
        return _repository.ConfirmAsync(
            request,
            _currentUser.UserId,
            performedByPartner: false,
            cancellationToken);
    }

    public Task<Guid> ConfirmPartnerAsync(
        ConfirmBenefitUsageRequest request,
        CancellationToken cancellationToken = default)
    {
    ...
    public Task CancelAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return _repository.CancelAsync(
            usageId,
            request,
            _currentUser.UserId,
            cancellationToken);
    ...
    public Task<BenefitUsageDetailDto?> GetByIdAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return _repository.GetByIdAsync(usageId, cancellationToken);
    }

    public Task<PagedResultDto<BenefitUsageListItemDto>> SearchAdminAsync(
    ...
    public Task<PagedResultDto<BenefitUsageListItemDto>> SearchPartnerAsync(
        BenefitUsageFilterDto filter,
        CancellationToken cancellationToken = default)
    {
